    ...
    <div className="min-h-screen p-4 page-transition overflow-x-hidden">
      <div className="max-w-md mx-auto space-y-4 overflow-x-hidden">
        ...
        <div className="gradient-card-blue animate-fade-in">
          ...
          <div className="relative w-full aspect-square max-w-xs mx-auto overflow-hidden">
            {/* Radar Background */}
            ...
            {/* Radar Lines */}
            <div className="absolute top-1/2 left-0 right-0 h-px bg-green-400 opacity-20"></div>
            <div className="absolute left-1/2 top-0 bottom-0 w-px bg-green-400 opacity-20"></div>
            
            {/* Center Dot */}
            <div className="absolute top-1/2 left-1/2 w-2 h-2 bg-green-400 rounded-full transform -translate-x-1/2 -translate-y-1/2"></div>
            
            {/* Sweep Animation */}
            <div className="absolute top-1/2 left-1/2 w-full h-px bg-gradient-to-r from-green-400 to-transparent transform -translate-y-1/2 origin-left rotate-45 animate-pulse"></div>
          </div>
          <p className="text-center text-green-400 text-sm mt-4 font-semibold">Scanning...</p>
        </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-red-500 text-sm font-semibold">No Signal</span>
                </div>
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-yellow-500 text-sm font-semibold">2 Found</span>
                </div>
              </div>
              <div className="w-full bg-surface-300 rounded-full h-2">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-green-500 text-sm font-semibold">5 Detected</span>
                </div>
              </div>
              <div className="w-full bg-surface-300 rounded-full h-2">
